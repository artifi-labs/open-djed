...
import { transactionUtxoSchema, type TransactionUtxo } from "../schemas/transaction/transactionUtxo.schema"
...
export class TransactionsService {
  ...
  async getTransactionUtxos(address: string): Promise<TransactionUtxo> {
    return this.client.request(`${this.basePath}/${address}/utxos`, transactionUtxoSchema)
  }
}
